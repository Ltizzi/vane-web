<template lang="">
  ...
  <div
    class="flex flex-col gap-7 font-playfair lg:h-auto 2xl:h-auto pt-0 lg:text-xl text-lg relative 2xl:my-40 text-base-100 mt-10 caret-transparent"
  >
    <img
      :src="bg"
...
<script setup>
  ...
  useHead({
    ...
    meta: [
      {
        name: "About me. Lic. Vanesa Carlotto Miranda - Psicóloga - Terapia Virtual - Terapia Remota - Online",
        content:
      ...
      {
        name: "About me. Lic. Vanesa Carlotto Miranda - Psychologist - Virtual terapy - Remote Terapy - Online",
        content:
