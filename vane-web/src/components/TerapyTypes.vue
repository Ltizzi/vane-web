...
<script setup>
  ...
  useHead({
    title:
      "Information - Psicóloga - Terapia Virtual - Terapia Remota - Psychologist - Virtual terapy - Remote Terapy - Online",
    meta: [
      {
        name: "Información sobre las terapias. Lic. Vanesa Carlotto Miranda - Psicóloga - Terapia Virtual - Terapia Remota - Online",
        content:
